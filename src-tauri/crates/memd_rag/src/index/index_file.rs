...
const DATA_OFFSET: usize = MAX_PAGE_ID_OFFSET + MAX_PAGE_ID_SIZE;
...
fn test_index_file() {
    ...
    let mut index_file = IndexFile::create(path, page_size, vector_unit_size).unwrap();
